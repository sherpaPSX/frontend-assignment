...
export class TodosService {
   ...
   * @throws ApiError
   */
  public static getTodoById(id: string): CancelablePromise<TodoResponse> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/api/todo/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static deleteTodoById(id: string): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/todo/{id}',
      path: {
   ...
   * @throws ApiError
   */
  public static createTodo(requestBody?: TodoRequest): CancelablePromise<TodoResponse> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/todo',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static markTodoComplete(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
   ...
   * @throws ApiError
   */
  public static markTodoIncomplete(id: string): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: 'POST',
