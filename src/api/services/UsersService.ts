...
export class UsersService {
   ...
   * @throws ApiError
   */
  public static registerUser(requestBody: User): CancelablePromise<Tokens> {
   ...
   * @throws ApiError
   */
  public static loginUser(requestBody: User): CancelablePromise<Tokens> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/login',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static refreshToken(requestBody: {refreshToken: string}): CancelablePromise<{
    /**
